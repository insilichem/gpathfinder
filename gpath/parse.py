...
class Settings(Munch):
    ...
    ga.population : int, defaults to 12
        Size of the starting population, in number of individuals.
    ga.generations : int, defaults to 500
    ...
    ga.lambda_ : float, optional, defaults to 1.0
    ...
    ga.mut_pb : float, optional, defaults to 0.8
        The probability that an offspring is produced by mutation.
    ga.mut_indpb : float, optional, defaults to 1.0
    ...
    ga.cx_eta : float, optional, defaults to 5
        ...
        much more different.
    ga.cx_pb : float, optional, defaults to 0.2
