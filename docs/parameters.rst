...
- **method** {'prody', 'gaussian', 'pca'}: `prody` to calculate normal modes using prody algorithms, `gaussian` to read normal modes from a gaussian output file and `pca` to perform a PCA analysis over a .dcd trajectory. **Default: prody**
